...
COLLECTION_THEMES = {
    ...
    # New collections (2026 batch)
    'alien icons': ['film', 'scifi', 'alien', 'horror'],
    'scooby doo': ['cartoon', 'tv', 'warnerbros', 'mystery'],
    'dr- seuss': ['drseuss', 'children', 'illustration', 'book'],
    'dr. seuss': ['drseuss', 'children', 'illustration', 'book'],
    'dr  seuss': ['drseuss', 'children', 'illustration', 'book'],
    'seuss': ['drseuss', 'children', 'illustration', 'book'],
    'dilbert': ['comics', 'office', 'humor'],
    'fillerbunny': ['comics', 'jhonenvasquez', 'humor'],
    'norbik nudley': ['eclectic'],
    'norbik': ['eclectic'],
    'the_nondescrips': ['minimal'],
    'geometria_noir': ['geometric', 'minimal'],
    'art folders': ['folder', 'art'],
    'macmania': ['mac', 'apple'],
    'dog-s life': ['animal', 'dog'],
    'mr- bean': ['tv', 'comedy', 'british'],
    'mr. bean': ['tv', 'comedy', 'british'],
    'munderful': ['eclectic'],
    'lalaland': ['eclectic'],
    'movy-cons': ['film'],
    'classic monster': ['horror', 'film', 'monster', 'classic'],
    'far-side': ['comics', 'humor', 'farside'],
    'far side': ['comics', 'humor', 'farside'],
    'bebox': ['hardware', 'beos'],
    'tintin': ['comics', 'adventure', 'european'],
    'expo -99': ['event', 'retro'],
    'ren-stimpy': ['cartoon', 'tv', 'nickelodeon'],
    'ren&stimpy': ['cartoon', 'tv', 'nickelodeon'],
}
